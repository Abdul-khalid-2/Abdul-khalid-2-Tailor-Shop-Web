        ...
        <nav class="iq-sidebar-menu">
            <ul id="iq-sidebar-toggle" class="iq-menu">
                ...
                <li class="{{ request()->is('orders*') ? 'active' : '' }}">
                    <a href="#orders" class="collapsed" data-toggle="collapse" aria-expanded="{{ request()->is('orders*') ? 'true' : 'false' }}">
                        ...
                        <svg class="svg-icon iq-arrow-right {{ request()->is('orders*') ? 'arrow-active' : '' }}" width="20" height="20" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                            <polyline points="10 15 15 20 20 15"></polyline>
                            <path d="M4 4h7a4 4 0 0 1 4 4v12"></path>
                        </svg>
                    </a>
                    <ul id="orders" class="iq-submenu collapse {{ request()->is('orders*') ? 'show' : '' }}" data-parent="#iq-sidebar-toggle">
                ...
                <li class="{{ request()->is('tailors*') ? 'active' : '' }}">
                    <a href="#tailors" class="collapsed" data-toggle="collapse" aria-expanded="{{ request()->is('tailors*') ? 'true' : 'false' }}">
                        <svg class="svg-icon" width="20" height="20" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                        ...
                        <svg class="svg-icon iq-arrow-right {{ request()->is('tailors*') ? 'arrow-active' : '' }}" width="20" height="20" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                            <polyline points="10 15 15 20 20 15"></polyline>
                            <path d="M4 4h7a4 4 0 0 1 4 4v12"></path>
                        </svg>
                    </a>
                    <ul id="tailors" class="iq-submenu collapse {{ request()->is('tailors*') ? 'show' : '' }}" data-parent="#iq-sidebar-toggle">
                ...
                <li class="{{ request()->is('fabrics*') ? 'active' : '' }}">
                    <a href="#fabrics" class="collapsed" data-toggle="collapse" aria-expanded="{{ request()->is('fabrics*') ? 'true' : 'false' }}">
                        <svg class="svg-icon" width="20" height="20" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                            <rect x="3" y="3" width="18" height="18" rx="2" ry="2"></rect>
                        ...
                        <svg class="svg-icon iq-arrow-right {{ request()->is('fabrics*') ? 'arrow-active' : '' }}" width="20" height="20" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                            <polyline points="10 15 15 20 20 15"></polyline>
                            <path d="M4 4h7a4 4 0 0 1 4 4v12"></path>
                        </svg>
                    </a>
                    <ul id="fabrics" class="iq-submenu collapse {{ request()->is('fabrics*') ? 'show' : '' }}" data-parent="#iq-sidebar-toggle">
                ...
                <li class="{{ request()->is('payments*') ? 'active' : '' }}">
                    <a href="#payments" class="collapsed" data-toggle="collapse" aria-expanded="{{ request()->is('payments*') ? 'true' : 'false' }}">
                        <svg class="svg-icon" width="20" height="20" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                            <line x1="12" y1="1" x2="12" y2="23"></line>
                            <path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"></path>
                        </svg>
                        <span class="ml-4">Payments</span>
                        <svg class="svg-icon iq-arrow-right {{ request()->is('payments*') ? 'arrow-active' : '' }}" width="20" height="20" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                            <polyline points="10 15 15 20 20 15"></polyline>
                            <path d="M4 4h7a4 4 0 0 1 4 4v12"></path>
                        </svg>
                    </a>
                    <ul id="payments" class="iq-submenu collapse {{ request()->is('payments*') ? 'show' : '' }}" data-parent="#iq-sidebar-toggle">
